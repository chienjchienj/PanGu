...
namespace PanGu.Match
{
    public class ChsFullTextMatch: IChsFullTextMatch
    {
        ...
        private void CombineNodeArr(Node[] result, Node[] arr)
        {
            ...
            //如果result 的有效值數量少於 arr,將result 的有效值填充到和arr相等
            //如果result 沒有一個有效值，則不做處理
        ...
        /// <summary>
        ///根據孤立點拆分長句，然後再分別對各個句子的片段進行分詞.
        ///長中文句子的分詞困擾了我3年，一直沒有好的解決方案。沒想到在觀看
        ///2010年世界盃開幕式時，我突發靈感，想出了這個孤立點分割拆分長句的
        ///算法，徹底解決的這個長期困擾我的難題. 
        ///eaglet 11th Jun 2010 註釋留念
        /// </summary>
        /// <param name="positionLenArr">保護位置和長度信息的單詞份量數組</param>
        /// <param name="orginalTextLength">原始字符串長度</param>
